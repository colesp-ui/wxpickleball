  ...
  return (
    <>
      ...
      <main className="tournament-page">
        ...
        <section className="section tournament-register" id="register"><div className="container"><div className="tournament-register-box"><img src={LOGO} alt="WX Pickleball"/><div><div className="kicker dark-kicker">Support WX Pickleball</div><h2>Ready to play?</h2><p>Register your team and submit your tournament payment through Venmo.</p></div><div className="actions"><a className="btn cta-btn" href={REGISTRATION_URL} target="_blank" rel="noopener noreferrer">Register Your Team</a><a className="btn btn-secondary" href={PAYMENT_URL} target="_blank" rel="noopener noreferrer">Pay with Venmo</a></div></div></div></section>
      </main>

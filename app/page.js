...
export default function Home() {
  return (
    <>
      ...
      <main>
        <section className="hero" id="home"><div className="container hero-grid"><div className="hero-inner"><div className="kicker">Woods Cross High School Pickleball</div><h1>A home for Woods Cross pickleball players, families, schedules, results, tournaments, and sponsors.</h1><div className="actions"><a className="btn btn-primary" href="#schedule">View Schedule</a><a className="btn btn-secondary" href="#team">Meet the Team</a></div></div><div className="hero-logo-wrap"><img className="hero-logo" src={LOGO} alt="WX Pickleball wildcat logo" /></div></div></section>
        ...
        <section className="section" id="team"><div className="container"><div className="kicker">Our Goals</div><h2>What we’re building.</h2><p className="section-lead">WX Pickleball is built around four goals that shape how we practice, compete, and show up for each other.</p><div className="grid grid-4 goals-grid" style={{marginTop:36}}><div className="card"><div className="metric">01</div><h3>Develop</h3><p>Develop fundamental pickleball skills and techniques.</p></div><div className="card"><div className="metric">02</div><h3>Character</h3><p>Focus on sportsmanship, accountability, and team camaraderie.</p></div><div className="card"><div className="metric">03</div><h3>Compete</h3><p>Compete at the highest level in the state.</p></div><div className="card"><div className="metric">04</div><h3>Have Fun</h3><p>Work hard, enjoy the game, and make the season something we’ll remember.</p></div></div></div></section>
